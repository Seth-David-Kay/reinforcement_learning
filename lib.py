...
class neural_net:
    ...
    def rank_players(self, player_dict):
        ...
        for player in player_dict:
            ...
            if highest_point > highest_point_percent_difference:
                final_score = 0.6*highest_point + 0.3 * (100-total_time_of_highest_point) + 0.1*final_height
            else:
                final_score = 0.9*highest_point + 0.1*final_height
            ...
            # should be 34.8 , so uniformly adjust the values based off of that.
